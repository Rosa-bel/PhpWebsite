...
class ZoneEvents {
    ...
    public function afficher($nb, $title) {
        ...
        $evenements = $c->getevenement();
        
        if ($nb > 0) {
            $evenements = array_slice($evenements, 0, $nb);
        }
        ...
        foreach ($evenements as $evenement) {
            ...
            if (!empty($evenement['photo'])) {
                echo '<img src="' . '../' . htmlspecialchars($evenement['photo']) . '" alt="' . htmlspecialchars($evenement['nom']) . '">';
            } else {
            ...
            echo '<h3>' . htmlspecialchars($evenement['nom']) . '</h3>';
            
            echo '<span class="category-badge">' . htmlspecialchars($evenement['categorie']) . '</span>';
            
            $description = strlen($evenement['description']) > 100 ? 
                substr($evenement['description'], 0, 97) . '...' : 
